...
if (!function_exists('yarn_setup')) :
    ...
    function yarn_setup()
    {
        ...
        add_image_size('logo_partner', 150, 150);
...
add_action('wp_enqueue_scripts', 'register_new_jquery');
function register_new_jquery()
{
...
//	wp_register_style('uikit-css', get_template_directory_uri() . '/app/css/uikit.min.css');
    wp_register_style('uikit-css', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-beta.40/css/uikit.min.css');
...
//	wp_enqueue_script( 'yarn-jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js', true );
    ...
    wp_register_script('uikit-js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-beta.40/js/uikit.min.js', array('jquery'), null, true);
