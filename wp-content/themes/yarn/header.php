...
<header class="header-top" uk-sticky>
    <div
        class="uk-container uk-flex uk-flex-row uk-flex-middle uk-flex-wrap uk-flex-around@m uk-flex-between uk-height-1-1 uk-position-relative">
        <div class="uk-logo">
        ...
        <nav>
            ...
            <div id="offcanvas-nav" uk-offcanvas="overlay: true" class="uk-hidden@m">
                <div class="uk-offcanvas-bar uk-flex uk-flex-column">
                    ...
                    wp_nav_menu(array(
                        ...
                        'menu_class' => 'uk-navbar-nav uk-flex uk-flex-column uk-flex-left',
                        'walker' => new My_Walker_Nav_Menu(),
                    ));
                    wp_nav_menu(array(
