...
<section class="uk-header-slider uk-visible@s">
	...
	<ul class="uk-slideshow-items">
		<?php if( have_rows('slider_top_home') ): ?>
			...
			<li>
				<img src="<?php echo $top_home_slide['url']; ?>" alt="<?php echo $top_home_slide['alt']; ?>" uk-cover>
			</li>
		<?php endif; ?>
	<?php endwhile; ?>
<?php endif; ?>
	...
	<div class="uk-container">
		...
		<div uk-grid>
			<div class="uk-margin-medium-top uk-width-1-1@m uk-text-center">
				<?php if( $link_shop ): ?>
					<a class="uk-catalog-front-page" href="<?php echo $link_shop['url']; ?>"><?php _e(' Каталог товаров ', 'yarn'); ?>
					</a>
				<?php endif; ?>
			</div>
		</div>
						...
						<div class="uk-text-center">
							<figure>
								<?php if( !empty($reviews_image) ): ?>
									<img class="uk-margin-auto" src="<?php echo $reviews_image['url']; ?>" alt="<?php echo $reviews_image['alt']; ?>">
								<?php endif; ?>
								<?php
